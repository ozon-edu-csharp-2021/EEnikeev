...
{
    public class MerchManagerDomainServiceMock : IMerchManagerDomainService
    {
        private IEmployeeRepository _employeeRepository;
        private IStockRepository _stockRepository;

        public MerchManagerDomainServiceMock(IEmployeeRepository employeeRepository, IStockRepository stockRepository)
        {
