...
namespace OzonEdu.MerchandiseService.Infrastructure.Broker.Serializers
{
    public class ProducerJsonSerializer<TMessage> : ISerializer<TMessage>, IDeserializer<TMessage>
    {
